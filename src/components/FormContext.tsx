...
export function FormProvider (props: IFormContextProps): JSX.Element {
  ...
  async function handleSearch (): Promise<void> {
    try {
      if (process.env.REACT_APP_API_URL === undefined || process.env.REACT_APP_API_KEY === undefined) {
        process.env.REACT_APP_API_URL = 'localhost'
        process.env.REACT_APP_API_KEY = 'localhost'
      }
